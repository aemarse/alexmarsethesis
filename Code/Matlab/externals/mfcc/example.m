...
%   Author: Kamil Wojcicki, September 2011
    ...
    wav_file = '/Volumes/ALEX/data/xeno_canto/Ring-billed Gull/Larus delawarensis_Ring-billed Gull_53947.mp3';  % input audio filename


    % Read speech samples, sampling rate and precision from file
    [ speech, fs, nbits ] = mp3read( wav_file );


    % Feature extraction (feature vectors as columns)
    [ MFCCs, FBEs, frames, H, MAG ] = ...
