...
%   Author  Kamil Wojcicki, UTD, June 2011
    ...
    M  = params.feat.numFilts;
    K  = params.win.Nfft/2+1;
    R  = [params.feat.lowFreq params.feat.highFreq];
    fs = params.file.fs;
    ...
    c  = convToHertz( convToMel(f_low)+[0:M+1]*((convToMel(f_high)-...
        convToMel(f_low))/(M+1)) );
    cw = convToMel( c );
